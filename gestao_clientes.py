...
class App(ctk.CTk):
    ...
    def todo_sistema(self):
        ...
        span = ctk.CTkLabel(self, text="Por favor, preencha todos os campos do formulario!", font=("Century Gothic bold", 16), text_color=["#000", "#fff"]).place(x=50, y=70)
        ...
        adress_entry = ctk.CTkEntry(self, width=200, textvariable=address_value, font=("Century Gothic bold", 16), fg_color="transparent")
        #Combobox
        ...
        lb_observation = ctk.CTkLabel(self, text="Observações", font=("Century Gothic bold", 16), text_color=["#000", "#fff"])
        #Botoes para submeter
        ...
        lb_observation.place(x=50, y=260)
